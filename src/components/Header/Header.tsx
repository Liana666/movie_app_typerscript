    ...
    <>
      <header className={header.headerWrapper}>
        ...
        <div className={header.link_wrapper}>
          <NavLink data-testid="movie-link" to="/movie">
            Фильмы
          </NavLink>
          <NavLink
            data-testid="profile-link"
            className={header.link}
            to="/profile/all-movies"
          >
            Избранное
          </NavLink>
        ...
        <div className={header.mob_header}>
          {isTrue ? (
            <>
              ...
              <div className={header.back_active}>
                <div className={header.menu}>
                  <NavLink className={header.menu_link} to="/movie">
                    Фильмы
                  </NavLink>
                  <NavLink
            ...
            <>
              <div className={header.icon} onClick={changeMenuIcon}>
                Menu
              </div>
